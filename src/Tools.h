...
#define dataTypeSetSim uint
#define dataTypeTotSim ulong // Number of total similarity values
/*
...
#endif
*/
#define dataTypeSimsRow map<dataTypeNSeq, dataTypeSim>
#define dataTypeSimsMat vector<dataTypeSimsRow>
#define dataTypeSet std::set<dataTypeNSeq>
//#define dataTypeSet unordered_set<dataTypeNSeq>
#define dataTypeAllSets map<dataTypeNSeq, dataTypeSet>

#define dataTypeSimsRowS2 map<dataTypeNSeq, dataTypeSetSim>
#define dataTypeSimsMatS2 vector<dataTypeSimsRowS2>
